<template>
    <div>
      ...
      <div class="customCardGroup">
        ...
        <img style="margin: 5px 0px; border-radius: 10%; float: left;" width="200px" height="200px" :src="`https://soapy-speckle-galaxy.glitch.me/pictures/getpicture?picturename=${name}`" />
