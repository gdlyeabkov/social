<template>
    <div id="app">
        ...
        <div class="customCardGroup">
            ...
            <form style="max-width: 650px; min-width: 400px; margin: auto;" class="registerForm" enctype="multipart/form-data"  method="POST" :action="`https://opalescent-soapy-baseball.glitch.me/users/usercreatesuccess?useremail=${useremail}&userpassword=${userpassword}&userage=${userage}&username=${username}`">
