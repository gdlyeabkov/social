      ...
      <Header :auth="'true'" :sender="touser.split('@')[0]"/>
        <div class="customflex">
          ...
          <div class="main">
            ...
            <img style="margin: 5px 0px; border-radius: 10%; float: left;" width="200px" height="200px" :src="`https://confirmed-giant-utahraptor.glitch.me/pictures/getpicture?picturename=${name}`" />
