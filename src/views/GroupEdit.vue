<template>
    <div>
      ...
      <div class="customCardGroup">
        <form style="max-width: 650px; min-width: 400px; margin: auto;" class="registerForm" enctype="multipart/form-data"  method="POST" :action="`https://showbellow.herokuapp.com/users/groups/editsuccess?previousgroupname=${previousgroupname}&groupname=${groupname}&groupdescription=${groupdescription}&groupaccess=${groupaccess}&imageurl=${imageurl}&touser=${touser}`">
          ...
          <img width="85px" height="85px" :src="`https://opalescent-soapy-baseball.glitch.me/pictures/getpicture?picturename=${groupname}`" />
