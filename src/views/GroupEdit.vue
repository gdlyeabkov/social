<template>
    <div>
      ...
      <div class="customCardGroup">
        <form style="max-width: 650px; min-width: 400px; margin: auto;" class="registerForm" enctype="multipart/form-data"  method="POST" :action="`https://confirmed-giant-utahraptor.glitch.me/users/groups/editsuccess?previousgroupname=${previousgroupname}&groupname=${groupname}&groupdescription=${groupdescription}&groupaccess=${groupaccess}&imageurl=${imageurl}&touser=${touser}`">
          ...
          <img width="85px" height="85px" :src="`https://confirmed-giant-utahraptor.glitch.me/pictures/getpicture?picturename=${groupname}`" />
